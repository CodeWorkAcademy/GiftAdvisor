...
public class GiftAdvisor {
    ...
    {
        System.out.print("Input recipient's gender (male or female): ");
    ...
    {
        System.out.print("Input giver\'s price range (low, medium, or high): ");
    ...
    {
        System.out.print("Input recipient's age range (adult, teen, or child): ");
